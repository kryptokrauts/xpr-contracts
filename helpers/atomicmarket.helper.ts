...
export const regMarket = async (atomicmarket: Account, creator: Account, marketplaceName?: string) => {
    ...
    await atomicmarket.actions.regmarket([
        creator.name,
        marketplaceName ? marketplaceName : creatorName
...
export const startAnnouncedAuction = async (atomicassets: Account, atomicmarket: Account, seller: Account, nfts: Array<NFT>) => {
