// error messages
export const ERROR_ONLY_ONE_SPOT_NFT_ALLOWED: string =
  'only one spot can nft be redeemed for promotion';
...
export const ERROR_COLLECTION_NOT_BLACKLISTED: string =
  'collection not blacklisted';
export const ERROR_COLLECTION_ALREADY_BLACKLISTED: string =
  'collection already blacklisted';
export const ERROR_COLLECTION_NOT_VERIFIED: string = 'collection not verified';
export const ERROR_COLLECTION_NEITHER_VERIFIED_NOR_SHIELDED: string =
  'collection neither verified nor shielded';
export const ERROR_COLLECTION_ALREADY_VERIFIED: string =
  'collection already verified';
...
export const ERROR_INVALID_NFT_SILVER_SPOT_EXPECTED: string =
  'invalid nft - silver spot expected';
export const ERROR_AUCTION_NOT_STARTED: string = 'auction not started yet';
export const ERROR_AUCTION_EXPIRED_OR_CLOSE_TO_EXPIRATION: string =
  'auction expired or close to expiration';

// error missing authority
export const ERROR_MISSING_REQUIRED_AUTHORITY_SOONMARKET: string =
  'missing required authority soonmarket';
